### Inference Functions from OpenIntro Labs
# Edited 10/25/2020 by Brian Gill
# Adjusted inference for means to use t-distribution regardless of sample size
# Changes made in lines 191, 403-404, 438-445, 756-757, and 808-815 of original script
# Original functions obtained from 
# http://www.openintro.org/stat/data/atheism.RData
